...
public class JTask
{
  ...
  /**
   * @author Jonathan
   * a todo list application written in java
   **/
  ...
  /**
   * iterates through a list of tasks and prints out all the items
   * @param list the list of tasks to iterate through
   **/
   ...
   * @param the list of entries to save
   **/
  ...
  /**
   * removes all tasks from a list that are marked as complete
   * @param list the list to purge
   * @return a list with all completed items removed
   **/
